...
class MemberPasswordsGetDstTest extends PHPUnit_Framework_TestCase {
	...
	public function testget_dst_data() {
		$member_passwords = $this->model->get_dst_data($this->chunk_id);

		$this->assertNotEmpty($member_passwords);
		$this->assertNotEmpty($member_passwords['10000000']);
		$this->assertEquals("10000000", $member_passwords['10000000']['member_id']);
		$this->assertNotEmpty($member_passwords['10000000']['salt']);
		$this->assertEquals(md5($member_passwords['10000000']['salt']."foobar123"), $member_passwords['10000000']['hash']);
	}
}
