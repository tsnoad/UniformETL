...
class MemberInvoicesGetSrcTest extends PHPUnit_Framework_TestCase {
	protected function setUp() {
		...
		runq("CREATE TABLE dump_{$this->extract_id}_invoice (customerid TEXT, batchid TEXT, batchposition TEXT, invoicetypeid TEXT, invoicestatusid TEXT, amount TEXT);");
		runq("INSERT INTO dump_{$this->extract_id}_invoice (customerid, batchid, batchposition, invoicetypeid, invoicestatusid, amount) VALUES ('10000000', 'something', '1234', 'INV', 'ACQU', '3.14');");
	}
