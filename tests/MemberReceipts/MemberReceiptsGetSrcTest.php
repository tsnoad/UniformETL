...
class MemberReceiptsGetSrcTest extends PHPUnit_Framework_TestCase {
	protected function setUp() {
		...
		runq("CREATE TABLE dump_{$this->extract_id}_receipt (customerid TEXT, batchid TEXT, batchposition TEXT, receipttypeid TEXT, receiptstatusid TEXT, amount TEXT);");
		runq("INSERT INTO dump_{$this->extract_id}_receipt (customerid, batchid, batchposition, receipttypeid, receiptstatusid, amount) VALUES ('10000000', 'something', '1234', 'SING', 'PROC', '3.14');");
	}
