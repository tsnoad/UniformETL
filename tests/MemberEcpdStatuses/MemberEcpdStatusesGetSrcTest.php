...
class MemberEcpdStatusesGetSrcTest extends PHPUnit_Framework_TestCase {
	protected function setUp() {
		...
		runq("CREATE TABLE dump_{$this->extract_id}_groupmember (customerid TEXT, groupid TEXT);");
		runq("INSERT INTO dump_{$this->extract_id}_groupmember (customerid, groupid) VALUES ('10000000', '6052');");
	}
