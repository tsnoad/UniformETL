...
Class Plugins {
	public static $plugins = array(
		...
		array("models_required-transforms", "MemberNmepStatuses", "hook_models_required_transforms"),
		...
		array("models_required-transforms", "MemberSecretQuestions", "hook_models_required_transforms"),
		...
		array("models_required-tables", "MemberNmepStatuses", "hook_models_required_tables"),
		...
		array("models_required-tables", "MemberSecretQuestions", "hook_models_required_tables"),
		...
		array("models_required-columns", "MemberNmepStatuses", "hook_models_required_columns"),
		...
		array("models_transform-priority", "MemberNmepStatuses", "hook_models_transform_priority"),
		...
		array("models_transform-priority", "MemberSecretQuestions", "hook_models_transform_priority"),
		...
		array("extract_index-sql", "MemberNmepStatuses", "hook_extract_index_sql"),
		...
		array("extract_index-sql", "MemberSecretQuestions", "hook_extract_index_sql"),
...
/* 		array("api_get-users_singles", "MemberWebStatuses", "hook_api_get_member"), */
		...
		array("api_get-users_singles", "MemberNmepStatuses", "hook_api_get_member"),
